...
(function (i) {
    ...
    var o = i.Axis,
        ...
        y = i.Series,
        F = i.VMLRenderer,
        B = i.SVGRenderer.prototype.symbols,
        l = i.each,
        r = i.extend,
        t = i.extendClass,
        n = i.merge,
    ...
    q(s.prototype, "pinchTranslate", function (a,
        b, d, c, e, f, g, h, m) {
    ...
    r(D.prototype, {
        ...
        init: function (a, b) {
            var d = a.options.legend.layout !== "vertical",
                c;
        ...
        drawLegendSymbol: function (a, b) {
            var d = a.padding,
                c = a.options,
                e = this.horiz,
                f = j(c.symbolWidth, e ? 200 : 12),
                g = j(c.symbolHeight,
                    e ? 12 : 200),
                c = j(c.labelPadding, e ? 10 : 30);
            this.setLegendColor();
        ...
        drawCrosshair: function (a, b) {
            var d = !this.cross,
                ...
                f, g = this.pos,
                h = this.len;
            if (b) f = this.toPixels(b.value), f < g ? f = g - 2 : f > g + h && (f = g + h + 2), b.plotX = f, b.plotY = this.len - f, o.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = e, !d && this.cross && this.cross.attr({
        ...
        getDataClassLegendSymbols: function () {
            ...
            l(this.dataClasses, function (c, m) {
                ...
                d.push(i.extend({
                    ...
                    name: g,
                    options: {},
                    drawLegendSymbol: i.LegendSymbolMixin.drawRectangle,
                    visible: !0,
                    setState: u,
                    setVisible: function () {
                        z = this.visible = !z;
    ...
    r(x.prototype, {
        renderMapNavigation: function () {
            ...
            if (j(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (c in d)
                    if (d.hasOwnProperty(c)) f = n(b.buttonOptions, d[c]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, c === "zoomIn" ? "topbutton" : "bottombutton").attr({
                        width: f.width,
                        height: f.height,
                        title: a.options.lang[c],
                        zIndex: 5
                    }).css(f.style).add(), e.handler = f.onclick, e.align(r(f, {
                        width: e.width,
                        height: 2 * e.height
                    }), null, f.alignTo)
        },
        ...
        mapZoom: function (a, b, d, c, e) {
            ...
            i *= a;
            h = this.fitToBox({
                x: h - m * (c ? (c - f.pos) / f.len : 0.5),
                y: k - i * (e ? (e - g.pos) / g.len : 0.5),
                width: m,
                height: i
            }, {
                x: f.dataMin,
    ...
    s = t(w, {
        applyOptions: function (a, b) {
            var d = w.prototype.applyOptions.call(this, a, b),
                c = this.series,
                e = c.options,
                f = e.joinBy;
            if (e.mapData)
                if (e = f ? c.getMapData(f, d[f]) : e.mapData[d.x]) {
    ...
    k.map = t(k.scatter, {
        ...
        translatePath: function (a) {
            var b = !1,
                ...
                i, j = [];
            if (a)
                for (i = a.length; i--;) typeof a[i] === "number" ? (j[i] = b ? (a[i] - e) * f + d : (a[i] - g) * h + c, b = !b) : j[i] = a[i];
            return j
        },
        ...
        getMapData: function (a, b) {
            var d = this.options.mapData,
                ...
                e = d.length;
            if (!c) c = this.mapMap = {};
            if (c[b] !== void 0) return d[c[b]];
            else if (b !== void 0)
                for (; e--;)
                    if (d[e][a] === b) return c[b] = e, d[e]
        },
        ...
        drawPoints: function () {
            ...
            if (!this.transformGroup) this.transformGroup = f.g().attr({
                scaleX: 1,
                scaleY: 1
            }).add(c);
            this.isDirtyData || f.isVML ? (this.group = this.transformGroup, k.column.prototype.drawPoints.apply(this), this.group = c, l(this.points, function (a) {
                ...
                (a = g(a, Math.max(1, this.chart.mapRatio)), b = g(b, 1 / Math.min(1, this.chart.mapRatio))), this.transformGroup.animate({
                    translateX: a,
                    translateY: b,
                    scaleX: d,
                    scaleY: d
    ...
    k.mappoint = t(k.scatter, {
        type: "mappoint"
    });
    if (k.bubble) p.mapbubble = n(p.bubble, {
        tooltip: {
            pointFormat: "{point.name}: {point.z}"
        }
    }), k.mapbubble = t(k.bubble, {
        pointClass: t(w, {
            applyOptions: s.prototype.applyOptions
        }),
        xyFromShape: !0,
        type: "mapbubble",
        pointArrayMap: ["z"],
